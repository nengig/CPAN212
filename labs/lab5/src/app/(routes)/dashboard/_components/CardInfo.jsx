...
function CardInfo({ budgetList, incomeList }) {
    ...
    useEffect(()=>{
        if(totalBudget > 0 || totalIncome.length >0 || totalSpend >0){
            ...
            {budgetList.length > 0 ? (
                <div>
                    ...
                    <div className="mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <PiggyBank className="rounded-full bg-blue-800 p-3 h-12 w-12 text-white" />
                    ...
                    <div className="mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <ReceiptText className="rounded-full bg-blue-800 p-3 h-12 w-12 text-white" />
                    ...
                    <div className="mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <Wallet className="rounded-full bg-blue-800 p-3 h-12 w-12 text-white" />
                    ...
                    <div className="mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <CircleDollarSign className="rounded-full bg-blue-800 p-3 h-12 w-12 text-white" />
